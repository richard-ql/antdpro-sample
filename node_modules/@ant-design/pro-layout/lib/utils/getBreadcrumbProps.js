...
var defaultItemRender = function defaultItemRender(route) {
  return _react.default.createElement("a", null, route.breadcrumbName);
};
...
var conversionFromLocation = function conversionFromLocation(routerLocation, breadcrumb, props) {
  if (!routerLocation) {
    return [];
...
var getBreadcrumbProps = function getBreadcrumbProps(props) {
  ...
  var routes = genBreadcrumbProps(props);
