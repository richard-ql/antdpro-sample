...
function (_Component) {
  ...
  function SiderMenu(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(SiderMenu).call(this, props));
  ...
  _createClass(SiderMenu, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          _onCollapse = _this$props.onCollapse,
      ...
      return React.createElement(Sider, {
        ...
        id: "logo"
      }, React.createElement("a", null, defaultRenderLogo(logo), React.createElement("h1", null, title))), React.createElement(BaseMenu, Object.assign({}, this.props, {
        mode: "inline",
    ...
    value: function getDerivedStateFromProps(props, state) {
      var pathname = state.pathname,
          flatMenuKeysLen = state.flatMenuKeysLen;
      var _props$location = props.location,
          location = _props$location === void 0 ? {
        pathname: '/'
      } : _props$location,
          _props$flatMenuKeys = props.flatMenuKeys,
          flatMenuKeys = _props$flatMenuKeys === void 0 ? [] : _props$flatMenuKeys;
