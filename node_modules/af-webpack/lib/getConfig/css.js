...
function _default(webpackConfig, opts) {
  ...
  function applyCSSRules(rule, {
    ...
    rule.use('css-loader').loader(opts.cssLoaderVersion === 2 ? require.resolve('css-loader') : require.resolve('css-loader-1')).options(_objectSpread({}, cssOpts, cssModules ? cssModulesConfig : {}));
